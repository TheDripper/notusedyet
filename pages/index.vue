    ...
    <div class="container flex flex-col items-center mx-auto p-6">
      ...
      <div>
        ...
        <div class="items-start">
          ...
          <p class="magenta now py-32">These men present the facade of conflict because to know they are cooperating would be too plainly dystopian to hide. They bicker for a few seconds to get it online but they are all working together for the same goal: to wield the <strong><a href="https://en.wikipedia.org/wiki/Military%E2%80%93industrial_complex">Venture Capital Surveillance Complex</a></strong> as an iron fist so they can rest in a luxury penthouse and take moderate doses of designer drugs while their entourage of <a href="https://en.wikipedia.org/wiki/Bourgeoisie" target="_blank">Bourgeoisie</a> clowns take turns licking their their Gucci loafers to a shine.</p>
        </div>
        <img src="/mac.png" />
      </div>
