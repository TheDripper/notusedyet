      ...
      <div>
        ...
        <p>
          ...
          <img src="/unicorns_such_rarity.png" />
           slaps a <span class="now magenta"><a href="https://en.wikipedia.org/wiki/Software_as_a_service" target="_blank">SaaS</a>y padlock on progress</span> and begins an <a href="https://en.wikipedia.org/wiki/Lisdexamfetamine" target="_blank">amphetaminic</a> <span class="magenta">hype ritual</span> with <span class="magenta">bright colors</span> and <span class="magenta">cute cartoon</span> characters and a whole <a href="https://aws.amazon.com/elasticbeanstalk/" target="_blank">quasi-magical</a> language of <a href="https://www.drift.com/blog/what-is-growth-marketing/" target="_blank">metaphor and imagery</a> to obfuscate the fact that they’re just reselling a <span class="magenta">spreadsheet</span>, or some <span class="magenta">scripts</span> to pipe data from <a href="https://zapier.com/pricing" target="_blank">Vendor A to Vendor B.</a></p>
